...
import {handleError, handleGenericServerError, sendErrorResponse} from "../../services/error-handler";
...
export class DateiController {
  static async post(req: Request, res: Response) {
    ...
    //return await DateiModel.create(datei)
  }
...
export async function deleteFile(req: Request, res: Response) {
  try {
    ...
    */
    ...
    const filename = path.join(__dirname, '../../public/uploads/' + datei.fileNameServer)
